        ...
        this.state = {
            events: [
                ...
                },
                {
                    ...
                    location: "Canteen",
                    description: "Project evaluation while declaring a variable and using an if statement is a fine"
                }
            ]
        };
    }
                ...
                <MDBContainer>
                    <MDBRow>
                        ...
                        <MDBCol md="3">
                            ...
                            <h6 className="my-3">
                                Your going to be busy today. You have{" "}
                            ...
                            <h1 className="my-3">
                                ...
                                <MDBRow>
                                    ...
                                    <MDBCol xs="9">79°F</MDBCol>
                                </MDBRow>
                            </h1>
                            <p>
                                Don't forget your sunglasses. Today will be dry and sunny, becoming warm
                                in the afternoon with temperatures between 70 and 82 degrees.
                            </p>
                        </MDBCol>
                    </MDBRow>
                </MDBContainer>
